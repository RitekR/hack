...
function createAnimationCard(session) {
    return new builder.AnimationCard(session)
        ...
        .media([
            { url: 'https://media3.giphy.com/media/3o7qDWoeN6PaJ6Z6RW/giphy.gif' }
        ])
        .buttons([
            builder.CardAction.openUrl(session, 'https://azure.microsoft.com/en-us/pricing/', 'YES'),
            builder.CardAction.openUrl(session, 'https://azure.microsoft.com/en-us/pricing/', 'No')
